import {FirestoreLimitToLastContextConfiguration} from '../configuration/context/firestore-limit-to-last-context.configuration';

/**
 * @ignore
 */
export const FIRESTORE_LIMIT_TO_LAST_METADATA_KEY: string = 'firestoreLimit';
