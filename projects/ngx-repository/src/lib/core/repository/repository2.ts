...
import { REPOSITORY_METADATA_KEY, RepositoryConfiguration } from '../decorator/repository.decorator';
...
export abstract class Repository2 {
  ...
  protected getRepositoryContextConfiguration(): RepositoryConfiguration {
