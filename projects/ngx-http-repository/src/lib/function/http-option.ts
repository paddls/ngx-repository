 ...
 */
export function httpOption<R, Q = any, B = any>(params: string | HttpRequestParamsContext, responseType: TypeGetter): HttpQueryFn<R, Q> | HttpBodyFn<R, B, Q> {
  return buildHttpRequestFunction(params, responseType, 'OPTION', false);
}
