 ...
 */
export function httpPatch<R, B = any, Q = any>(params: string | HttpRequestParamsContext, responseType: TypeGetter): HttpBodyFn<R, B, Q> | HttpQueryFn<R, Q> {
  return buildHttpRequestFunction(params, responseType, 'PATCH', true);
}
